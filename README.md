...
Editeur de code (par ex. : [VS Code](https://code.visualstudio.com/download?_exp_download=fb315fc982)), [Git](https://git-scm.com/install/), [Node](https://nodejs.org/en/download)

## Etape 1 : Cloner le dépôt

Ouvrez dans votre éditeur de code le dossier dans lequel vous voulez copier le projet, puis ouvrez y un terminal. </br> Ensuite, tapez cette commande : 
```bash
...
- **State** : La *state* est la mémoire d'un *composant*, il permet de faire réagir un *composant* lorsqu'on le modifie.
