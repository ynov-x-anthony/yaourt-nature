  ...
  return (
    ...
    <>
      <div>
          {movies.map((movie) => (
            <div key={movie.title}>
              <button type="button" onClick={() => setMovieId(movie.id)}>
                {movie.id}
              </button>
            </div>
          ))}
